...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 df 78 10 80 	movl   $0x801078df,(%esp)
...
8010082f:	75 54                	jne    80100885 <consoleintr+0x95>
    ...
    case C('H'): case '\x7f':  // Backspace
      if(input.e != input.w){
80100831:	a1 08 00 11 80       	mov    0x80110008,%eax
80100836:	3b 05 04 00 11 80    	cmp    0x80110004,%eax
8010083c:	74 d2                	je     80100810 <consoleintr+0x20>
        input.e--;
8010083e:	83 e8 01             	sub    $0x1,%eax
80100841:	a3 08 00 11 80       	mov    %eax,0x80110008
        consputc(BACKSPACE);
...
80100889:	a1 08 00 11 80       	mov    0x80110008,%eax
8010088e:	89 c2                	mov    %eax,%edx
80100890:	2b 15 00 00 11 80    	sub    0x80110000,%edx
...
801008a5:	83 ff 0d             	cmp    $0xd,%edi
        input.buf[input.e++ % INPUT_BUF] = c;
801008a8:	89 15 08 00 11 80    	mov    %edx,0x80110008
        consputc(BACKSPACE);
      }
      break;
    default:
...
801008b6:	88 88 80 ff 10 80    	mov    %cl,-0x7fef0080(%eax)
        consputc(c);
...
801008d5:	a1 00 00 11 80       	mov    0x80110000,%eax
801008da:	83 e8 80             	sub    $0xffffff80,%eax
801008dd:	39 05 08 00 11 80    	cmp    %eax,0x80110008
...
801008e9:	83 ec 0c             	sub    $0xc,%esp
      if(c != 0 && input.e-input.r < INPUT_BUF){
        ...
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
          input.w = input.e;
801008ec:	a3 04 00 11 80       	mov    %eax,0x80110004
          wakeup(&input.r);
801008f1:	68 00 00 11 80       	push   $0x80110000
...
80100908:	a1 08 00 11 80       	mov    0x80110008,%eax
8010090d:	39 05 04 00 11 80    	cmp    %eax,0x80110004
80100913:	75 2b                	jne    80100940 <consoleintr+0x150>
80100915:	e9 f6 fe ff ff       	jmp    80100810 <consoleintr+0x20>
8010091a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            input.buf[(input.e-1) % INPUT_BUF] != '\n'){
        input.e--;
80100920:	a3 08 00 11 80       	mov    %eax,0x80110008
        consputc(BACKSPACE);
...
8010092a:	e8 c1 fa ff ff       	call   801003f0 <consputc>
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
8010092f:	a1 08 00 11 80       	mov    0x80110008,%eax
80100934:	3b 05 04 00 11 80    	cmp    0x80110004,%eax
...
80100945:	83 e2 7f             	and    $0x7f,%edx
    ...
    case C('U'):  // Kill line.
      while(input.e != input.w &&
80100948:	80 ba 80 ff 10 80 0a 	cmpb   $0xa,-0x7fef0080(%edx)
...
80100977:	e9 44 36 00 00       	jmp    80103fc0 <procdump>
    ...
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF){
        c = (c == '\r') ? '\n' : c;
        input.buf[input.e++ % INPUT_BUF] = c;
8010097c:	c6 80 80 ff 10 80 0a 	movb   $0xa,-0x7fef0080(%eax)
        consputc(c);
80100983:	b8 0a 00 00 00       	mov    $0xa,%eax
80100988:	e8 63 fa ff ff       	call   801003f0 <consputc>
8010098d:	a1 08 00 11 80       	mov    0x80110008,%eax
...
consoleinit(void)
{
  ...
  devsw[CONSOLE].write = consolewrite;
801009bb:	c7 05 cc 09 11 80 00 	movl   $0x80100600,0x801109cc
801009c2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009c5:	c7 05 c8 09 11 80 70 	movl   $0x80100270,0x801109c8
801009cc:	02 10 80 
  cons.locking = 1;
...
80100d5b:	68 20 00 11 80       	push   $0x80110020
...
80100d74:	bb 54 00 11 80       	mov    $0x80110054,%ebx
}
...
80100d79:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ftable.lock);
80100d7c:	68 20 00 11 80       	push   $0x80110020
...
80100d93:	81 fb b4 09 11 80    	cmp    $0x801109b4,%ebx
...
80100da5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dac:	68 20 00 11 80       	push   $0x80110020
...
80100dc3:	68 20 00 11 80       	push   $0x80110020
...
80100de7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dea:	68 20 00 11 80       	push   $0x80110020
...
80100e04:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e07:	68 20 00 11 80       	push   $0x80110020
...
80100e5c:	74 1a                	je     80100e78 <fileclose+0x48>
    release(&ftable.lock);
80100e5e:	c7 45 08 20 00 11 80 	movl   $0x80110020,0x8(%ebp)
...
80100e8d:	8b 47 10             	mov    0x10(%edi),%eax
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e90:	68 20 00 11 80       	push   $0x80110020
    panic("fileclose");
  if(--f->ref > 0){
    release(&ftable.lock);
    return;
...
8010110a:	03 15 38 0a 11 80    	add    0x80110a38,%edx
...
80101179:	8b 0d 20 0a 11 80    	mov    0x80110a20,%ecx
// Blocks.
...
8010119c:	03 05 38 0a 11 80    	add    0x80110a38,%eax
...
801011ae:	a1 20 0a 11 80       	mov    0x80110a20,%eax
...
80101207:	39 05 20 0a 11 80    	cmp    %eax,0x80110a20
...
8010128a:	bb 74 0a 11 80       	mov    $0x80110a74,%ebx
// Find the inode with number inum on device dev
// and return the in-memory copy. Does not lock
// the inode and does not read it from disk.
static struct inode*
...
80101292:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
80101295:	68 40 0a 11 80       	push   $0x80110a40
...
801012ba:	81 fb 94 26 11 80    	cmp    $0x80112694,%ebx
...
801012d8:	89 de                	mov    %ebx,%esi
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
      ip->ref++;
      release(&icache.lock);
801012da:	68 40 0a 11 80       	push   $0x80110a40
...
80101303:	81 fb 94 26 11 80    	cmp    $0x80112694,%ebx
...
80101323:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010132a:	68 40 0a 11 80       	push   $0x80110a40
...
80101464:	bb 80 0a 11 80       	mov    $0x80110a80,%ebx
80101469:	83 ec 0c             	sub    $0xc,%esp
  int i = 0;
  
  initlock(&icache.lock, "icache");
8010146c:	68 6b 70 10 80       	push   $0x8010706b
80101471:	68 40 0a 11 80       	push   $0x80110a40
...
80101497:	81 fb a0 26 11 80    	cmp    $0x801126a0,%ebx
...
801014a2:	68 20 0a 11 80       	push   $0x80110a20
801014a7:	ff 75 08             	pushl  0x8(%ebp)
801014aa:	e8 71 ff ff ff       	call   80101420 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014af:	ff 35 38 0a 11 80    	pushl  0x80110a38
801014b5:	ff 35 34 0a 11 80    	pushl  0x80110a34
801014bb:	ff 35 30 0a 11 80    	pushl  0x80110a30
801014c1:	ff 35 2c 0a 11 80    	pushl  0x80110a2c
801014c7:	ff 35 28 0a 11 80    	pushl  0x80110a28
801014cd:	ff 35 24 0a 11 80    	pushl  0x80110a24
801014d3:	ff 35 20 0a 11 80    	pushl  0x80110a20
...
801014f9:	83 3d 28 0a 11 80 01 	cmpl   $0x1,0x80110a28
// Allocate an inode on device dev.
// Mark it as allocated by  giving it type type.
// Returns an unlocked but allocated and referenced inode.
struct inode*
...
801015c4:	03 05 34 0a 11 80    	add    0x80110a34,%eax
...
80101637:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010163a:	68 40 0a 11 80       	push   $0x80110a40
8010163f:	e8 cc 2c 00 00       	call   80104310 <acquire>
  ip->ref++;
80101644:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101648:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
...
801016a9:	03 05 34 0a 11 80    	add    0x80110a34,%eax
...
801017ba:	e8 61 29 00 00       	call   80104120 <releasesleep>
  ...
  acquire(&icache.lock);
801017bf:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
801017c6:	e8 45 2b 00 00       	call   80104310 <acquire>
  ip->ref--;
801017cb:	83 6e 08 01          	subl   $0x1,0x8(%esi)
  release(&icache.lock);
801017cf:	83 c4 10             	add    $0x10,%esp
801017d2:	c7 45 08 40 0a 11 80 	movl   $0x80110a40,0x8(%ebp)
}
...
801017eb:	68 40 0a 11 80       	push   $0x80110a40
801017f0:	e8 1b 2b 00 00       	call   80104310 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
...
80101a1a:	8b 04 c5 c0 09 11 80 	mov    -0x7feef640(,%eax,8),%eax
...
80101b2a:	8b 04 c5 c4 09 11 80 	mov    -0x7feef63c(,%eax,8),%eax
...
{
  acquire(&icache.lock);
80101c64:	68 40 0a 11 80       	push   $0x80110a40
80101c69:	e8 a2 26 00 00       	call   80104310 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 40 0a 11 80 	movl   $0x80110a40,(%esp)
...
80101e98:	68 c6 76 10 80       	push   $0x801076c6
...
80101fd5:	58                   	pop    %eax
80101fd6:	a1 60 2d 11 80       	mov    0x80112d60,%eax
80101fdb:	5a                   	pop    %edx
...
801021e1:	c7 05 94 26 11 80 00 	movl   $0xfec00000,0x80112694
801021e8:	00 c0 fe 
  ioapic->data = data;
}
...
801021f6:	00 00 00 
  return ioapic->data;
801021f9:	8b 15 94 26 11 80    	mov    0x80112694,%edx
...
80102202:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
80102208:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
  int i, id, maxintr;
  ...
  if(id != ioapicid)
8010220e:	0f b6 15 c0 27 11 80 	movzbl 0x801127c0,%edx
ioapicinit(void)
{
  int i, id, maxintr;
...
80102234:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
...
80102250:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
80102252:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
    cprintf("ioapicinit: id isn't equal to ioapicid; not a MP\n");
...
8010226e:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
80102270:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
...
{
  ioapic->reg = reg;
80102291:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
  }
}
...
801022a3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022a5:	8b 0d 94 26 11 80    	mov    0x80112694,%ecx
}
...
801022b4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022b6:	a1 94 26 11 80       	mov    0x80112694,%eax
{
  // Mark interrupt edge-triggered, active high,
  // enabled, and routed to the given cpunum,
  // which happens to be that cpu's APIC ID.
...
801022e2:	81 fb 08 55 11 80    	cmp    $0x80115508,%ebx
...
80102302:	e8 09 21 00 00       	call   80104410 <memset>
  ...
  if(kmem.use_lock)
80102307:	8b 15 d4 26 11 80    	mov    0x801126d4,%edx
...
80102314:	a1 d8 26 11 80       	mov    0x801126d8,%eax
80102319:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010231b:	a1 d4 26 11 80       	mov    0x801126d4,%eax
  ...
  r->next = kmem.freelist;
  kmem.freelist = r;
80102320:	89 1d d8 26 11 80    	mov    %ebx,0x801126d8
  if(kmem.use_lock)
...
8010232f:	90                   	nop
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102330:	c7 45 08 a0 26 11 80 	movl   $0x801126a0,0x8(%ebp)
}
...
80102343:	68 a0 26 11 80       	push   $0x801126a0
...
801023c0:	68 a0 26 11 80       	push   $0x801126a0
...
kinit1(void *vstart, void *vend)
{
  initlock(&kmem.lock, "kmem");
  kmem.use_lock = 0;
801023d0:	c7 05 d4 26 11 80 00 	movl   $0x0,0x801126d4
801023d7:	00 00 00 
...
kinit2(void *vstart, void *vend)
{
  freerange(vstart, vend);
  kmem.use_lock = 1;
80102464:	c7 05 d4 26 11 80 01 	movl   $0x1,0x801126d4
8010246b:	00 00 00 
}
...
801024c3:	68 a0 26 11 80       	push   $0x801126a0
801024c8:	e8 43 1e 00 00       	call   80104310 <acquire>
  r = kmem.freelist;
801024cd:	8b 1d d8 26 11 80    	mov    0x801126d8,%ebx
  if(r)
801024d3:	83 c4 10             	add    $0x10,%esp
801024d6:	a1 d4 26 11 80       	mov    0x801126d4,%eax
...
{
  if(!lapic)
801025e0:	a1 dc 26 11 80       	mov    0x801126dc,%eax
}
...
{
  if (!lapic)
801026e0:	a1 dc 26 11 80       	mov    0x801126dc,%eax
  lapicw(TPR, 0);
}
...
{
  lapic[index] = value;
8010276e:	a1 dc 26 11 80       	mov    0x801126dc,%eax
...
801029a0:	8b 0d 28 27 11 80    	mov    0x80112728,%ecx
...
80102a24:	39 1d 28 27 11 80    	cmp    %ebx,0x80112728
...
80102a47:	ff 35 14 27 11 80    	pushl  0x80112714
80102a4d:	ff 35 24 27 11 80    	pushl  0x80112724
80102a53:	e8 78 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102a58:	8b 0d 28 27 11 80    	mov    0x80112728,%ecx
...
80102a78:	8b 8a 2c 27 11 80    	mov    -0x7feed8d4(%edx),%ecx
...
80102aaf:	68 e0 26 11 80       	push   $0x801126e0
...
80102acb:	59                   	pop    %ecx
  ...
  log.size = sb.nlog;
  log.dev = dev;
80102acc:	89 1d 24 27 11 80    	mov    %ebx,0x80112724
  ...
  log.start = sb.logstart;
  log.size = sb.nlog;
80102ad2:	89 15 18 27 11 80    	mov    %edx,0x80112718
    panic("initlog: too big logheader");
  ...
  readsb(dev, &sb);
  log.start = sb.logstart;
80102ad8:	a3 14 27 11 80       	mov    %eax,0x80112714
...
read_head(void)
{
  ...
  int i;
  log.lh.n = lh->n;
80102aed:	89 0d 28 27 11 80    	mov    %ecx,0x80112728
  for (i = 0; i < log.lh.n; i++) {
...
80102b07:	89 8a 28 27 11 80    	mov    %ecx,-0x7feed8d8(%edx)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80102b1a:	e8 81 fe ff ff       	call   801029a0 <install_trans>
  log.lh.n = 0;
80102b1f:	c7 05 28 27 11 80 00 	movl   $0x0,0x80112728
80102b26:	00 00 00 
...
80102b43:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102b46:	68 e0 26 11 80       	push   $0x801126e0
...
80102b5b:	68 e0 26 11 80       	push   $0x801126e0
80102b60:	68 e0 26 11 80       	push   $0x801126e0
...
begin_op(void)
{
  ...
  while(1){
    if(log.committing){
80102b6d:	a1 20 27 11 80       	mov    0x80112720,%eax
80102b72:	85 c0                	test   %eax,%eax
80102b74:	75 e2                	jne    80102b58 <begin_op+0x18>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102b76:	a1 1c 27 11 80       	mov    0x8011271c,%eax
80102b7b:	8b 15 28 27 11 80    	mov    0x80112728,%edx
...
80102b8f:	83 ec 0c             	sub    $0xc,%esp
      ...
      log.outstanding += 1;
80102b92:	a3 1c 27 11 80       	mov    %eax,0x8011271c
      release(&log.lock);
80102b97:	68 e0 26 11 80       	push   $0x801126e0
...
80102bb6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102bb9:	68 e0 26 11 80       	push   $0x801126e0
80102bbe:	e8 4d 17 00 00       	call   80104310 <acquire>
  log.outstanding -= 1;
80102bc3:	a1 1c 27 11 80       	mov    0x8011271c,%eax
  if(log.committing)
80102bc8:	8b 1d 20 27 11 80    	mov    0x80112720,%ebx
...
end_op(void)
{
  ...
  acquire(&log.lock);
  log.outstanding -= 1;
80102bd6:	a3 1c 27 11 80       	mov    %eax,0x8011271c
  if(log.committing)
...
80102be9:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(log.outstanding == 0){
    do_commit = 1;
    log.committing = 1;
80102bec:	c7 05 20 27 11 80 01 	movl   $0x1,0x80112720
80102bf3:	00 00 00 
}
...
80102bf6:	31 db                	xor    %ebx,%ebx
  ...
  release(&log.lock);
80102bf8:	68 e0 26 11 80       	push   $0x801126e0
...
{
  if (log.lh.n > 0) {
80102c02:	8b 0d 28 27 11 80    	mov    0x80112728,%ecx
...
80102c7c:	3b 1d 28 27 11 80    	cmp    0x80112728,%ebx
...
80102c89:	e8 12 fd ff ff       	call   801029a0 <install_trans>
    log.lh.n = 0;
80102c8e:	c7 05 28 27 11 80 00 	movl   $0x0,0x80112728
80102c95:	00 00 00 
...
80102ca0:	68 e0 26 11 80       	push   $0x801126e0
80102ca5:	e8 66 16 00 00       	call   80104310 <acquire>
    log.committing = 0;
    wakeup(&log);
80102caa:	c7 04 24 e0 26 11 80 	movl   $0x801126e0,(%esp)
  if(do_commit){
    // call commit w/o holding locks, since not allowed
    // to sleep with locks.
    commit();
    acquire(&log.lock);
    log.committing = 0;
80102cb1:	c7 05 20 27 11 80 00 	movl   $0x0,0x80112720
80102cb8:	00 00 00 
    wakeup(&log);
80102cbb:	e8 10 12 00 00       	call   80103ed0 <wakeup>
    release(&log.lock);
80102cc0:	c7 04 24 e0 26 11 80 	movl   $0x801126e0,(%esp)
...
80102ce3:	68 e0 26 11 80       	push   $0x801126e0
80102ce8:	e8 e3 11 00 00       	call   80103ed0 <wakeup>
  }
  release(&log.lock);
80102ced:	c7 04 24 e0 26 11 80 	movl   $0x801126e0,(%esp)
...
80102d27:	8b 15 28 27 11 80    	mov    0x80112728,%edx
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
...
80102d59:	68 e0 26 11 80       	push   $0x801126e0
80102d5e:	e8 ad 15 00 00       	call   80104310 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102d63:	8b 15 28 27 11 80    	mov    0x80112728,%edx
...
80102d74:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102d76:	3b 0d 2c 27 11 80    	cmp    0x8011272c,%ecx
80102d7c:	75 0b                	jne    80102d89 <log_write+0x69>
80102d7e:	eb 38                	jmp    80102db8 <log_write+0x98>
80102d80:	39 0c 85 2c 27 11 80 	cmp    %ecx,-0x7feed8d4(,%eax,4)
...
80102d90:	89 0c 95 2c 27 11 80 	mov    %ecx,-0x7feed8d4(,%edx,4)
  if (i == log.lh.n)
    log.lh.n++;
80102d97:	83 c2 01             	add    $0x1,%edx
80102d9a:	89 15 28 27 11 80    	mov    %edx,0x80112728
  b->flags |= B_DIRTY; // prevent eviction
80102da0:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102da3:	c7 45 08 e0 26 11 80 	movl   $0x801126e0,0x8(%ebp)
}
...
80102db4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  log.lh.block[i] = b->blockno;
80102db8:	89 0c 85 2c 27 11 80 	mov    %ecx,-0x7feed8d4(,%eax,4)
80102dbf:	eb df                	jmp    80102da0 <log_write+0x80>
80102dc1:	8b 43 08             	mov    0x8(%ebx),%eax
80102dc4:	a3 2c 27 11 80       	mov    %eax,0x8011272c
  if (i == log.lh.n)
...
80102e5f:	bb e0 27 11 80       	mov    $0x801127e0,%ebx
// Allocate a real stack and switch to it, first
// doing some setup required for memory allocator to work.
int
main(void)
...
80102e6c:	68 08 55 11 80       	push   $0x80115508
...
80102ec9:	e8 f2 15 00 00       	call   801044c0 <memmove>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102ece:	69 05 60 2d 11 80 b0 	imul   $0xb0,0x80112d60,%eax
80102ed5:	00 00 00 
80102ed8:	83 c4 10             	add    $0x10,%esp
80102edb:	05 e0 27 11 80       	add    $0x801127e0,%eax
...
80102f38:	74 f6                	je     80102f30 <main+0xe0>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102f3a:	69 05 60 2d 11 80 b0 	imul   $0xb0,0x80112d60,%eax
80102f41:	00 00 00 
80102f44:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102f4a:	05 e0 27 11 80       	add    $0x801127e0,%eax
...
801030bf:	a3 dc 26 11 80       	mov    %eax,0x801126dc
...
80103135:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    ...
    case MPPROC:
      ...
      if(ncpu < NCPU) {
80103138:	8b 0d 60 2d 11 80    	mov    0x80112d60,%ecx
...
80103150:	89 0d 60 2d 11 80    	mov    %ecx,0x80112d60
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    switch(*p){
    case MPPROC:
      proc = (struct mpproc*)p;
      if(ncpu < NCPU) {
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
80103156:	88 97 e0 27 11 80    	mov    %dl,-0x7feed820(%edi)
        ncpu++;
      }
...
8010316c:	83 c0 08             	add    $0x8,%eax
    ...
    case MPIOAPIC:	
      ioapic = (struct mpioapic*)p;
      ioapicid = ioapic->apicno;
8010316f:	88 15 c0 27 11 80    	mov    %dl,0x801127c0
      p += sizeof(struct mpioapic);
      continue;
...
801035a4:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
// If found, change state to EMBRYO and initialize
// state required to run in the kernel.
// Otherwise return 0.
static struct proc*
...
801035a9:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
801035ac:	68 80 2d 11 80       	push   $0x80112d80
...
801035c3:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
...
801035da:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  ...
  release(&ptable.lock);
801035e1:	68 80 2d 11 80       	push   $0x80112d80
  release(&ptable.lock);
  return 0;
...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 98 56 10 80 	movl   $0x80105698,0x14(%eax)
...
80103643:	68 80 2d 11 80       	push   $0x80112d80
...
80103663:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103666:	68 80 2d 11 80       	push   $0x80112d80
...
801036bb:	68 80 2d 11 80       	push   $0x80112d80
...
801036dc:	e8 ff ef ff ff       	call   801026e0 <lapicid>
  ...
  for (i = 0; i < ncpu; ++i) {
801036e1:	8b 35 60 2d 11 80    	mov    0x80112d60,%esi
801036e7:	85 f6                	test   %esi,%esi
801036e9:	7e 3f                	jle    8010372a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
801036eb:	0f b6 15 e0 27 11 80 	movzbl 0x801127e0,%edx
801036f2:	39 d0                	cmp    %edx,%eax
801036f4:	74 30                	je     80103726 <mycpu+0x56>
801036f6:	b9 90 28 11 80       	mov    $0x80112890,%ecx
...
8010371d:	5b                   	pop    %ebx
  ...
  for (i = 0; i < ncpu; ++i) {
    if (cpus[i].apicid == apicid)
      return &cpus[i];
8010371e:	05 e0 27 11 80       	add    $0x801127e0,%eax
  }
  panic("unknown apicid\n");
}
80103723:	5e                   	pop    %esi
...
8010373a:	68 98 75 10 80       	push   $0x80107598
...
8010375b:	2d e0 27 11 80       	sub    $0x801127e0,%eax
}
80103760:	c9                   	leave  
}
...
80103856:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103859:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103865:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  ...
  release(&ptable.lock);
8010386c:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
801039c6:	8b 5f 10             	mov    0x10(%edi),%ebx
  ...
  acquire(&ptable.lock);
801039c9:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
801039d5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  ...
  release(&ptable.lock);
801039dc:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103a51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a54:	bb b4 2d 11 80       	mov    $0x80112db4,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103a59:	68 80 2d 11 80       	push   $0x80112d80
...
80103a73:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
...
80103a8b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a8e:	e8 0d 2e 00 00       	call   801068a0 <switchuvm>
      p->state = RUNNING;
...
80103aa0:	e8 c6 0b 00 00       	call   8010466b <swtch>
      switchkvm();
80103aa5:	e8 d6 2d 00 00       	call   80106880 <switchkvm>
...
80103aaa:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103aad:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103ac3:	68 80 2d 11 80       	push   $0x80112d80
...
80103afd:	68 80 2d 11 80       	push   $0x80112d80
...
80103b60:	68 f0 74 10 80       	push   $0x801074f0
...
80103b6d:	68 1c 75 10 80       	push   $0x8010751c
...
80103b7a:	68 0e 75 10 80       	push   $0x8010750e
...
80103b87:	68 02 75 10 80       	push   $0x80107502
...
80103c04:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  ...
  acquire(&ptable.lock);
80103c0b:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103c47:	3d b4 4c 11 80       	cmp    $0x80114cb4,%eax
...
80103c54:	ba b4 2d 11 80       	mov    $0x80112db4,%edx
...
80103c63:	81 fa b4 4c 11 80    	cmp    $0x80114cb4,%edx
...
80103c79:	b8 b4 2d 11 80       	mov    $0x80112db4,%eax
...
80103c83:	3d b4 4c 11 80       	cmp    $0x80114cb4,%eax
...
80103cad:	68 3d 75 10 80       	push   $0x8010753d
...
80103cba:	68 30 75 10 80       	push   $0x80107530
...
80103cd7:	68 80 2d 11 80       	push   $0x80112d80
...
80103cfd:	e8 de fd ff ff       	call   80103ae0 <sched>
  release(&ptable.lock);
80103d02:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103d50:	81 fe 80 2d 11 80    	cmp    $0x80112d80,%esi
80103d56:	74 50                	je     80103da8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103d58:	83 ec 0c             	sub    $0xc,%esp
80103d5b:	68 80 2d 11 80       	push   $0x80112d80
...
80103d7c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103d83:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103dc9:	68 4f 75 10 80       	push   $0x8010754f
...
80103dd6:	68 49 75 10 80       	push   $0x80107549
...
80103dfd:	68 80 2d 11 80       	push   $0x80112d80
...
80103e31:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e36:	81 fb b4 4c 11 80    	cmp    $0x80114cb4,%ebx
...
80103e4e:	68 80 2d 11 80       	push   $0x80112d80
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 a4 2d 00 00       	call   80106c20 <freevm>
        p->pid = 0;
...
80103e95:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103e9c:	c7 04 24 80 2d 11 80 	movl   $0x80112d80,(%esp)
...
80103eb7:	68 80 2d 11 80       	push   $0x80112d80
...
80103ed7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103eda:	68 80 2d 11 80       	push   $0x80112d80
...
80103f0f:	3d b4 4c 11 80       	cmp    $0x80114cb4,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f16:	c7 45 08 80 2d 11 80 	movl   $0x80112d80,0x8(%ebp)
}
...
80103f6f:	68 80 2d 11 80       	push   $0x80112d80
...
80103f9b:	68 80 2d 11 80       	push   $0x80112d80
...
80103fc9:	bb 20 2e 11 80       	mov    $0x80112e20,%ebx
...
80103fdb:	68 df 78 10 80       	push   $0x801078df
...
80103fe8:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103feb:	81 fb 20 4d 11 80    	cmp    $0x80114d20,%ebx
...
80103ffe:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104001:	ba 60 75 10 80       	mov    $0x80107560,%edx
  uint pc[10];
...
80104008:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010400f:	b8 60 75 10 80       	mov    $0x80107560,%eax
...
8010401e:	68 64 75 10 80       	push   $0x80107564
...
8010405d:	68 a1 6f 10 80       	push   $0x80106fa1
...
8010408a:	68 d8 75 10 80       	push   $0x801075d8
...
801042c5:	68 fa 75 10 80       	push   $0x801075fa
...
801042d2:	68 e3 75 10 80       	push   $0x801075e3
...
801043b3:	68 01 76 10 80       	push   $0x80107601
...
801043fc:	68 09 76 10 80       	push   $0x80107609
...
80104816:	83 ec 0c             	sub    $0xc,%esp
  int num;
  struct proc *curproc = myproc();
80104819:	e8 52 ef ff ff       	call   80103770 <myproc>
...
80104821:	89 c6                	mov    %eax,%esi
  ...
  num = curproc->tf->eax;
80104823:	8b 5f 1c             	mov    0x1c(%edi),%ebx
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104826:	8d 43 ff             	lea    -0x1(%ebx),%eax
80104829:	83 f8 16             	cmp    $0x16,%eax
8010482c:	77 22                	ja     80104850 <syscall+0x40>
8010482e:	8b 04 9d 40 76 10 80 	mov    -0x7fef89c0(,%ebx,4),%eax
...
8010483b:	89 47 1c             	mov    %eax,0x1c(%edi)
        scuses[num]++;
8010483e:	83 04 9d 20 ff 10 80 	addl   $0x1,-0x7fef00e0(,%ebx,4)
80104845:	01 
  } else {
...
80104846:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104849:	5b                   	pop    %ebx
8010484a:	5e                   	pop    %esi
8010484b:	5f                   	pop    %edi
8010484c:	5d                   	pop    %ebp
...
8010484e:	66 90                	xchg   %ax,%ax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80104850:	8d 46 6c             	lea    0x6c(%esi),%eax
  num = curproc->tf->eax;
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    curproc->tf->eax = syscalls[num]();
        scuses[num]++;
...
80104855:	ff 76 10             	pushl  0x10(%esi)
80104858:	68 11 76 10 80       	push   $0x80107611
8010485d:	e8 fe bd ff ff       	call   80100660 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
80104862:	8b 46 18             	mov    0x18(%esi),%eax
80104865:	83 c4 10             	add    $0x10,%esp
80104868:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104897:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
8010489a:	e8 31 d6 ff ff       	call   80101ed0 <nameiparent>
...
801048b0:	e8 ab cd ff ff       	call   80101660 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
801048b5:	83 c4 0c             	add    $0xc,%esp
801048b8:	6a 00                	push   $0x0
801048ba:	56                   	push   %esi
801048bb:	57                   	push   %edi
801048bc:	e8 cf d2 ff ff       	call   80101b90 <dirlookup>
801048c1:	83 c4 10             	add    $0x10,%esp
801048c4:	85 c0                	test   %eax,%eax
801048c6:	89 c3                	mov    %eax,%ebx
801048c8:	74 56                	je     80104920 <create+0xa0>
    iunlockput(dp);
801048ca:	83 ec 0c             	sub    $0xc,%esp
801048cd:	57                   	push   %edi
801048ce:	e8 1d d0 ff ff       	call   801018f0 <iunlockput>
    ilock(ip);
801048d3:	89 1c 24             	mov    %ebx,(%esp)
801048d6:	e8 85 cd ff ff       	call   80101660 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801048db:	83 c4 10             	add    $0x10,%esp
801048de:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801048e3:	75 1b                	jne    80104900 <create+0x80>
801048e5:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
...
80104904:	e8 e7 cf ff ff       	call   801018f0 <iunlockput>
    return 0;
...
8010492a:	e8 c1 cb ff ff       	call   801014f0 <ialloc>
...
80104961:	e8 4a cc ff ff       	call   801015b0 <iupdate>
...
80104978:	e8 73 d4 ff ff       	call   80101df0 <dirlink>
...
80104988:	e8 63 cf ff ff       	call   801018f0 <iunlockput>
...
801049b9:	e8 f2 cb ff ff       	call   801015b0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
801049be:	83 c4 0c             	add    $0xc,%esp
801049c1:	ff 73 04             	pushl  0x4(%ebx)
801049c4:	68 bc 76 10 80       	push   $0x801076bc
801049c9:	53                   	push   %ebx
801049ca:	e8 21 d4 ff ff       	call   80101df0 <dirlink>
...
801049dc:	68 bb 76 10 80       	push   $0x801076bb
801049e1:	53                   	push   %ebx
801049e2:	e8 09 d4 ff ff       	call   80101df0 <dirlink>
...
801049f1:	68 af 76 10 80       	push   $0x801076af
...
801049fe:	68 be 76 10 80       	push   $0x801076be
...
80104a0b:	68 a0 76 10 80       	push   $0x801076a0
...
80104a44:	e8 27 ed ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104aab:	e8 c0 ec ff ff       	call   80103770 <myproc>
...
80104ada:	e8 01 c3 ff ff       	call   80100de0 <filedup>
  return fd;
...
80104b25:	e8 46 fc ff ff       	call   80104770 <argptr>
...
80104b3d:	e8 0e c4 ff ff       	call   80100f50 <fileread>
...
80104b95:	e8 d6 fb ff ff       	call   80104770 <argptr>
...
80104be3:	78 2b                	js     80104c10 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104be5:	e8 86 eb ff ff       	call   80103770 <myproc>
...
80104c3f:	e8 2c fb ff ff       	call   80104770 <argptr>
...
80104c54:	e8 a7 c2 ff ff       	call   80100f00 <filestat>
...
80104c7f:	e8 4c fb ff ff       	call   801047d0 <argstr>
...
80104c98:	e8 33 fb ff ff       	call   801047d0 <argstr>
...
80104ca2:	0f 88 e2 00 00 00    	js     80104d8a <sys_link+0x11a>
  ...
  begin_op();
80104ca8:	e8 93 de ff ff       	call   80102b40 <begin_op>
  if((ip = namei(old)) == 0){
80104cad:	83 ec 0c             	sub    $0xc,%esp
80104cb0:	ff 75 d4             	pushl  -0x2c(%ebp)
80104cb3:	e8 f8 d1 ff ff       	call   80101eb0 <namei>
...
80104cc9:	e8 92 c9 ff ff       	call   80101660 <ilock>
  if(ip->type == T_DIR){
...
80104ce8:	e8 c3 c8 ff ff       	call   801015b0 <iupdate>
  iunlock(ip);
80104ced:	89 1c 24             	mov    %ebx,(%esp)
80104cf0:	e8 4b ca ff ff       	call   80101740 <iunlock>
...
80104cfb:	e8 d0 d1 ff ff       	call   80101ed0 <nameiparent>
...
80104d0d:	e8 4e c9 ff ff       	call   80101660 <ilock>
...
80104d23:	e8 c8 d0 ff ff       	call   80101df0 <dirlink>
...
80104d33:	e8 b8 cb ff ff       	call   801018f0 <iunlockput>
  iput(ip);
80104d38:	89 1c 24             	mov    %ebx,(%esp)
80104d3b:	e8 50 ca ff ff       	call   80101790 <iput>

  end_op();
80104d40:	e8 6b de ff ff       	call   80102bb0 <end_op>
...
80104d5c:	e8 8f cb ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
80104d68:	e8 f3 c8 ff ff       	call   80101660 <ilock>
  ip->nlink--;
80104d6d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104d72:	89 1c 24             	mov    %ebx,(%esp)
80104d75:	e8 36 c8 ff ff       	call   801015b0 <iupdate>
  iunlockput(ip);
80104d7a:	89 1c 24             	mov    %ebx,(%esp)
80104d7d:	e8 6e cb ff ff       	call   801018f0 <iunlockput>
  end_op();
80104d82:	e8 29 de ff ff       	call   80102bb0 <end_op>
  return -1;
...
80104da4:	e8 47 cb ff ff       	call   801018f0 <iunlockput>
    end_op();
80104da9:	e8 02 de ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104db6:	eb 92                	jmp    80104d4a <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104db8:	e8 f3 dd ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104ddf:	e8 ec f9 ff ff       	call   801047d0 <argstr>
...
80104def:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80104df2:	e8 49 dd ff ff       	call   80102b40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104df7:	83 ec 08             	sub    $0x8,%esp
80104dfa:	53                   	push   %ebx
80104dfb:	ff 75 c0             	pushl  -0x40(%ebp)
80104dfe:	e8 cd d0 ff ff       	call   80101ed0 <nameiparent>
...
80104e1d:	58                   	pop    %eax
80104e1e:	5a                   	pop    %edx
80104e1f:	68 bc 76 10 80       	push   $0x801076bc
80104e24:	53                   	push   %ebx
80104e25:	e8 46 cd ff ff       	call   80101b70 <namecmp>
...
80104e38:	68 bb 76 10 80       	push   $0x801076bb
80104e3d:	53                   	push   %ebx
80104e3e:	e8 2d cd ff ff       	call   80101b70 <namecmp>
...
80104e57:	e8 34 cd ff ff       	call   80101b90 <dirlookup>
...
80104e6d:	e8 ee c7 ff ff       	call   80101660 <ilock>
...
80104ec2:	e8 29 ca ff ff       	call   801018f0 <iunlockput>

  ip->nlink--;
80104ec7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104ecc:	89 1c 24             	mov    %ebx,(%esp)
80104ecf:	e8 dc c6 ff ff       	call   801015b0 <iupdate>
  iunlockput(ip);
80104ed4:	89 1c 24             	mov    %ebx,(%esp)
80104ed7:	e8 14 ca ff ff       	call   801018f0 <iunlockput>

  end_op();
80104edc:	e8 cf dc ff ff       	call   80102bb0 <end_op>
...
80104f11:	e8 2a ca ff ff       	call   80101940 <readi>
...
80104f29:	e8 c2 c9 ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
80104f64:	e8 47 c6 ff ff       	call   801015b0 <iupdate>
...
80104f76:	e9 6b ff ff ff       	jmp    80104ee6 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
80104f7b:	e8 30 dc ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104f8d:	68 e0 76 10 80       	push   $0x801076e0
...
80104f9a:	68 f2 76 10 80       	push   $0x801076f2
...
80104fa7:	68 ce 76 10 80       	push   $0x801076ce
...
80104fcf:	e8 fc f7 ff ff       	call   801047d0 <argstr>
...
80104ff2:	0f 88 85 00 00 00    	js     8010507d <sys_open+0xbd>
  ...
  begin_op();
80104ff8:	e8 43 db ff ff       	call   80102b40 <begin_op>
...
8010500d:	e8 9e ce ff ff       	call   80101eb0 <namei>
...
80105023:	e8 38 c6 ff ff       	call   80101660 <ilock>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105043:	e8 28 e7 ff ff       	call   80103770 <myproc>
80105048:	90                   	nop
...
80105064:	e8 c7 bd ff ff       	call   80100e30 <fileclose>
80105069:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010506c:	83 ec 0c             	sub    $0xc,%esp
8010506f:	56                   	push   %esi
80105070:	e8 7b c8 ff ff       	call   801018f0 <iunlockput>
    end_op();
80105075:	e8 36 db ff ff       	call   80102bb0 <end_op>
    return -1;
...
801050c8:	e8 73 c6 ff ff       	call   80101740 <iunlock>
  end_op();
...
8010515f:	e8 8c c7 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105164:	e8 47 da ff ff       	call   80102bb0 <end_op>
  return 0;
...
8010516f:	c3                   	ret    
  ...
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    end_op();
80105170:	e8 3b da ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105194:	e8 37 f6 ff ff       	call   801047d0 <argstr>
...
801051ee:	e8 fd c6 ff ff       	call   801018f0 <iunlockput>
  end_op();
801051f3:	e8 b8 d9 ff ff       	call   80102bb0 <end_op>
  return 0;
...
801051ff:	90                   	nop
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80105200:	e8 ab d9 ff ff       	call   80102bb0 <end_op>
    return -1;
...
8010523f:	e8 6c cc ff ff       	call   80101eb0 <namei>
...
80105251:	e8 0a c4 ff ff       	call   80101660 <ilock>
  if(ip->type != T_DIR){
...
80105264:	e8 d7 c4 ff ff       	call   80101740 <iunlock>
  iput(curproc->cwd);
80105269:	58                   	pop    %eax
8010526a:	ff 76 68             	pushl  0x68(%esi)
8010526d:	e8 1e c5 ff ff       	call   80101790 <iput>
  end_op();
80105272:	e8 39 d9 ff ff       	call   80102bb0 <end_op>
  curproc->cwd = ip;
...
80105294:	e8 57 c6 ff ff       	call   801018f0 <iunlockput>
    end_op();
80105299:	e8 12 d9 ff ff       	call   80102bb0 <end_op>
    return -1;
...
801052d5:	e8 f6 f4 ff ff       	call   801047d0 <argstr>
...
80105318:	e8 f3 f0 ff ff       	call   80104410 <memset>
...
8010532e:	e8 4d f3 ff ff       	call   80104680 <fetchint>
...
80105349:	e8 72 f3 ff ff       	call   801046c0 <fetchstr>
...
801053b1:	e8 ba f3 ff ff       	call   80104770 <argptr>
...
801053c8:	e8 13 de ff ff       	call   801031e0 <pipealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801053d9:	e8 92 e3 ff ff       	call   80103770 <myproc>
...
801053f6:	e8 35 ba ff ff       	call   80100e30 <fileclose>
    fileclose(wf);
801053fb:	58                   	pop    %eax
801053fc:	ff 75 e4             	pushl  -0x1c(%ebp)
801053ff:	e8 2c ba ff ff       	call   80100e30 <fileclose>
    return -1;
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105422:	e8 49 e3 ff ff       	call   80103770 <myproc>
...
8010543e:	75 f0                	jne    80105430 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105440:	e8 2b e3 ff ff       	call   80103770 <myproc>
...
{
  return fork();
80105474:	e9 97 e4 ff ff       	jmp    80103910 <fork>
...
80105483:	83 ec 08             	sub    $0x8,%esp
  exit();
80105486:	e8 15 e7 ff ff       	call   80103ba0 <exit>
...
{
  return wait();
80105494:	e9 47 e9 ff ff       	jmp    80103de0 <wait>
...
801054ac:	e8 6f f2 ff ff       	call   80104720 <argint>
...
801054be:	e8 6d ea ff ff       	call   80103f30 <kill>
...
801054e3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801054e6:	e8 85 e2 ff ff       	call   80103770 <myproc>
...
80105516:	e8 75 e3 ff ff       	call   80103890 <growproc>
...
80105560:	68 c0 4c 11 80       	push   $0x80114cc0
80105565:	e8 a6 ed ff ff       	call   80104310 <acquire>
  ticks0 = ticks;
...
8010556d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105570:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  while(ticks - ticks0 < n){
...
80105583:	68 c0 4c 11 80       	push   $0x80114cc0
80105588:	68 00 55 11 80       	push   $0x80115500
8010558d:	e8 8e e7 ff ff       	call   80103d20 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105592:	a1 00 55 11 80       	mov    0x80115500,%eax
...
8010559f:	73 2f                	jae    801055d0 <sys_sleep+0x90>
    if(myproc()->killed){
801055a1:	e8 ca e1 ff ff       	call   80103770 <myproc>
...
801055b0:	68 c0 4c 11 80       	push   $0x80114cc0
801055b5:	e8 06 ee ff ff       	call   801043c0 <release>
      return -1;
...
801055d3:	68 c0 4c 11 80       	push   $0x80114cc0
801055d8:	e8 e3 ed ff ff       	call   801043c0 <release>
  return 0;
...
801055f4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801055f7:	68 c0 4c 11 80       	push   $0x80114cc0
801055fc:	e8 0f ed ff ff       	call   80104310 <acquire>
  xticks = ticks;
80105601:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  release(&tickslock);
80105607:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
8010560e:	e8 ad ed ff ff       	call   801043c0 <release>
  return xticks;
}
...
80105623:	83 ec 20             	sub    $0x20,%esp
  int n;
  scuses[21]++;  
80105626:	83 05 74 ff 10 80 01 	addl   $0x1,0x8010ff74
  if(argint(0, &n) < 0)
8010562d:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105630:	50                   	push   %eax
80105631:	6a 00                	push   $0x0
80105633:	e8 e8 f0 ff ff       	call   80104720 <argint>
80105638:	83 c4 10             	add    $0x10,%esp
8010563b:	85 c0                	test   %eax,%eax
8010563d:	78 11                	js     80105650 <sys_trace+0x30>
    return -1;
  return scuses[n];
8010563f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105642:	8b 04 85 20 ff 10 80 	mov    -0x7fef00e0(,%eax,4),%eax
}
80105649:	c9                   	leave  
8010564a:	c3                   	ret    
8010564b:	90                   	nop
...
80105669:	6a 04                	push   $0x4
8010566b:	50                   	push   %eax
8010566c:	6a 00                	push   $0x0
8010566e:	e8 fd f0 ff ff       	call   80104770 <argptr>
   cmostime(r);
80105673:	58                   	pop    %eax
80105674:	ff 75 f4             	pushl  -0xc(%ebp)
80105677:	e8 44 d1 ff ff       	call   801027c0 <cmostime>
   return 0;
  }
...
80105681:	06                   	push   %es
  pushl %fs
80105682:	0f a0                	push   %fs
  pushl %gs
80105684:	0f a8                	push   %gs
  pushal
80105686:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105687:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010568b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010568d:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010568f:	54                   	push   %esp
  call trap
80105690:	e8 fb 00 00 00       	call   80105790 <trap>
  addl $4, %esp
80105695:	83 c4 04             	add    $0x4,%esp
...
80105698:	61                   	popa   
  popl %gs
80105699:	0f a9                	pop    %gs
  popl %fs
8010569b:	0f a1                	pop    %fs
  popl %es
8010569d:	07                   	pop    %es
  popl %ds
8010569e:	1f                   	pop    %ds
...
extern int scuses[SCC];

void
tvinit(void)
{
801056b0:	b8 20 ff 10 80       	mov    $0x8010ff20,%eax
801056b5:	ba 7c ff 10 80       	mov    $0x8010ff7c,%edx
...
tvinit(void)
{
	...
	for(int i = 0; i < SCC; i++)
801056c9:	39 c2                	cmp    %eax,%edx
801056cb:	75 f3                	jne    801056c0 <tvinit+0x10>
...
801056d7:	b9 08 00 00 00       	mov    $0x8,%ecx
801056dc:	c6 04 c5 04 4d 11 80 	movb   $0x0,-0x7feeb2fc(,%eax,8)
801056e3:	00 
801056e4:	66 89 0c c5 02 4d 11 	mov    %cx,-0x7feeb2fe(,%eax,8)
801056eb:	80 
801056ec:	c6 04 c5 05 4d 11 80 	movb   $0x8e,-0x7feeb2fb(,%eax,8)
801056f3:	8e 
801056f4:	66 89 14 c5 00 4d 11 	mov    %dx,-0x7feeb300(,%eax,8)
801056fb:	80 
801056fc:	c1 ea 10             	shr    $0x10,%edx
801056ff:	66 89 14 c5 06 4d 11 	mov    %dx,-0x7feeb2fa(,%eax,8)
80105706:	80 
  ...
  int i;
  for(i = 0; i < 256; i++)
80105707:	83 c0 01             	add    $0x1,%eax
8010570a:	3d 00 01 00 00       	cmp    $0x100,%eax
8010570f:	75 bf                	jne    801056d0 <tvinit+0x20>
...
80105712:	ba 08 00 00 00       	mov    $0x8,%edx
...
80105719:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010571c:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105721:	68 01 77 10 80       	push   $0x80107701
80105726:	68 c0 4c 11 80       	push   $0x80114cc0
		scuses[i] = 0;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010572b:	66 89 15 02 4f 11 80 	mov    %dx,0x80114f02
80105732:	c6 05 04 4f 11 80 00 	movb   $0x0,0x80114f04
80105739:	66 a3 00 4f 11 80    	mov    %ax,0x80114f00
8010573f:	c1 e8 10             	shr    $0x10,%eax
80105742:	c6 05 05 4f 11 80 ef 	movb   $0xef,0x80114f05
80105749:	66 a3 06 4f 11 80    	mov    %ax,0x80114f06

  initlock(&tickslock, "time");
8010574f:	e8 5c ea ff ff       	call   801041b0 <initlock>
}
...
8010576b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010576f:	b8 00 4d 11 80       	mov    $0x80114d00,%eax
...
801057b0:	ff 24 85 a8 77 10 80 	jmp    *-0x7fef8858(,%eax,4)
...
80105815:	68 64 77 10 80       	push   $0x80107764
...
8010589b:	75 a8                	jne    80105845 <trap+0xb5>
    exit();
8010589d:	e8 fe e2 ff ff       	call   80103ba0 <exit>
...
801058ac:	75 ab                	jne    80105859 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801058ae:	e8 1d e4 ff ff       	call   80103cd0 <yield>
...
801058ff:	68 0c 77 10 80       	push   $0x8010770c
...
80105941:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105944:	e8 c7 ee ff ff       	call   80104810 <syscall>
    if(myproc()->killed)
...
8010595f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105960:	e9 3b e2 ff ff       	jmp    80103ba0 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105968:	e8 33 e2 ff ff       	call   80103ba0 <exit>
...
80105973:	68 c0 4c 11 80       	push   $0x80114cc0
80105978:	e8 93 e9 ff ff       	call   80104310 <acquire>
      ticks++;
      wakeup(&ticks);
8010597d:	c7 04 24 00 55 11 80 	movl   $0x80115500,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105984:	83 05 00 55 11 80 01 	addl   $0x1,0x80115500
      wakeup(&ticks);
8010598b:	e8 40 e5 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
80105990:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
80105997:	e8 24 ea ff ff       	call   801043c0 <release>
...
801059b8:	68 30 77 10 80       	push   $0x80107730
801059bd:	e8 9e ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059c2:	83 c4 14             	add    $0x14,%esp
801059c5:	68 06 77 10 80       	push   $0x80107706
...
80105abf:	bb 28 78 10 80       	mov    $0x80107828,%ebx
...
80105b57:	6a 00                	push   $0x0
  jmp alltraps
80105b59:	e9 22 fb ff ff       	jmp    80105680 <alltraps>
...
80105b60:	6a 01                	push   $0x1
  jmp alltraps
80105b62:	e9 19 fb ff ff       	jmp    80105680 <alltraps>
...
80105b69:	6a 02                	push   $0x2
  jmp alltraps
80105b6b:	e9 10 fb ff ff       	jmp    80105680 <alltraps>
...
80105b72:	6a 03                	push   $0x3
  jmp alltraps
80105b74:	e9 07 fb ff ff       	jmp    80105680 <alltraps>
...
80105b7b:	6a 04                	push   $0x4
  jmp alltraps
80105b7d:	e9 fe fa ff ff       	jmp    80105680 <alltraps>
...
80105b84:	6a 05                	push   $0x5
  jmp alltraps
80105b86:	e9 f5 fa ff ff       	jmp    80105680 <alltraps>
...
80105b8d:	6a 06                	push   $0x6
  jmp alltraps
80105b8f:	e9 ec fa ff ff       	jmp    80105680 <alltraps>
...
80105b96:	6a 07                	push   $0x7
  jmp alltraps
80105b98:	e9 e3 fa ff ff       	jmp    80105680 <alltraps>
...
80105b9d:	6a 08                	push   $0x8
  jmp alltraps
80105b9f:	e9 dc fa ff ff       	jmp    80105680 <alltraps>
...
80105ba6:	6a 09                	push   $0x9
  jmp alltraps
80105ba8:	e9 d3 fa ff ff       	jmp    80105680 <alltraps>
...
80105bad:	6a 0a                	push   $0xa
  jmp alltraps
80105baf:	e9 cc fa ff ff       	jmp    80105680 <alltraps>
...
80105bb4:	6a 0b                	push   $0xb
  jmp alltraps
80105bb6:	e9 c5 fa ff ff       	jmp    80105680 <alltraps>
...
80105bbb:	6a 0c                	push   $0xc
  jmp alltraps
80105bbd:	e9 be fa ff ff       	jmp    80105680 <alltraps>
...
80105bc2:	6a 0d                	push   $0xd
  jmp alltraps
80105bc4:	e9 b7 fa ff ff       	jmp    80105680 <alltraps>
...
80105bc9:	6a 0e                	push   $0xe
  jmp alltraps
80105bcb:	e9 b0 fa ff ff       	jmp    80105680 <alltraps>
...
80105bd2:	6a 0f                	push   $0xf
  jmp alltraps
80105bd4:	e9 a7 fa ff ff       	jmp    80105680 <alltraps>
...
80105bdb:	6a 10                	push   $0x10
  jmp alltraps
80105bdd:	e9 9e fa ff ff       	jmp    80105680 <alltraps>
...
80105be2:	6a 11                	push   $0x11
  jmp alltraps
80105be4:	e9 97 fa ff ff       	jmp    80105680 <alltraps>
...
80105beb:	6a 12                	push   $0x12
  jmp alltraps
80105bed:	e9 8e fa ff ff       	jmp    80105680 <alltraps>
...
80105bf4:	6a 13                	push   $0x13
  jmp alltraps
80105bf6:	e9 85 fa ff ff       	jmp    80105680 <alltraps>
...
80105bfd:	6a 14                	push   $0x14
  jmp alltraps
80105bff:	e9 7c fa ff ff       	jmp    80105680 <alltraps>
...
80105c06:	6a 15                	push   $0x15
  jmp alltraps
80105c08:	e9 73 fa ff ff       	jmp    80105680 <alltraps>
...
80105c0f:	6a 16                	push   $0x16
  jmp alltraps
80105c11:	e9 6a fa ff ff       	jmp    80105680 <alltraps>
...
80105c18:	6a 17                	push   $0x17
  jmp alltraps
80105c1a:	e9 61 fa ff ff       	jmp    80105680 <alltraps>
...
80105c21:	6a 18                	push   $0x18
  jmp alltraps
80105c23:	e9 58 fa ff ff       	jmp    80105680 <alltraps>
...
80105c2a:	6a 19                	push   $0x19
  jmp alltraps
80105c2c:	e9 4f fa ff ff       	jmp    80105680 <alltraps>
...
80105c33:	6a 1a                	push   $0x1a
  jmp alltraps
80105c35:	e9 46 fa ff ff       	jmp    80105680 <alltraps>
...
80105c3c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c3e:	e9 3d fa ff ff       	jmp    80105680 <alltraps>
...
80105c45:	6a 1c                	push   $0x1c
  jmp alltraps
80105c47:	e9 34 fa ff ff       	jmp    80105680 <alltraps>
...
80105c4e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c50:	e9 2b fa ff ff       	jmp    80105680 <alltraps>
...
80105c57:	6a 1e                	push   $0x1e
  jmp alltraps
80105c59:	e9 22 fa ff ff       	jmp    80105680 <alltraps>
...
80105c60:	6a 1f                	push   $0x1f
  jmp alltraps
80105c62:	e9 19 fa ff ff       	jmp    80105680 <alltraps>
...
80105c69:	6a 20                	push   $0x20
  jmp alltraps
80105c6b:	e9 10 fa ff ff       	jmp    80105680 <alltraps>
...
80105c72:	6a 21                	push   $0x21
  jmp alltraps
80105c74:	e9 07 fa ff ff       	jmp    80105680 <alltraps>
...
80105c7b:	6a 22                	push   $0x22
  jmp alltraps
80105c7d:	e9 fe f9 ff ff       	jmp    80105680 <alltraps>
...
80105c84:	6a 23                	push   $0x23
  jmp alltraps
80105c86:	e9 f5 f9 ff ff       	jmp    80105680 <alltraps>
...
80105c8d:	6a 24                	push   $0x24
  jmp alltraps
80105c8f:	e9 ec f9 ff ff       	jmp    80105680 <alltraps>
...
80105c96:	6a 25                	push   $0x25
  jmp alltraps
80105c98:	e9 e3 f9 ff ff       	jmp    80105680 <alltraps>
...
80105c9f:	6a 26                	push   $0x26
  jmp alltraps
80105ca1:	e9 da f9 ff ff       	jmp    80105680 <alltraps>
...
80105ca8:	6a 27                	push   $0x27
  jmp alltraps
80105caa:	e9 d1 f9 ff ff       	jmp    80105680 <alltraps>
...
80105cb1:	6a 28                	push   $0x28
  jmp alltraps
80105cb3:	e9 c8 f9 ff ff       	jmp    80105680 <alltraps>
...
80105cba:	6a 29                	push   $0x29
  jmp alltraps
80105cbc:	e9 bf f9 ff ff       	jmp    80105680 <alltraps>
...
80105cc3:	6a 2a                	push   $0x2a
  jmp alltraps
80105cc5:	e9 b6 f9 ff ff       	jmp    80105680 <alltraps>
...
80105ccc:	6a 2b                	push   $0x2b
  jmp alltraps
80105cce:	e9 ad f9 ff ff       	jmp    80105680 <alltraps>
...
80105cd5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cd7:	e9 a4 f9 ff ff       	jmp    80105680 <alltraps>
...
80105cde:	6a 2d                	push   $0x2d
  jmp alltraps
80105ce0:	e9 9b f9 ff ff       	jmp    80105680 <alltraps>
...
80105ce7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ce9:	e9 92 f9 ff ff       	jmp    80105680 <alltraps>
...
80105cf0:	6a 2f                	push   $0x2f
  jmp alltraps
80105cf2:	e9 89 f9 ff ff       	jmp    80105680 <alltraps>
...
80105cf9:	6a 30                	push   $0x30
  jmp alltraps
80105cfb:	e9 80 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d02:	6a 31                	push   $0x31
  jmp alltraps
80105d04:	e9 77 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d0b:	6a 32                	push   $0x32
  jmp alltraps
80105d0d:	e9 6e f9 ff ff       	jmp    80105680 <alltraps>
...
80105d14:	6a 33                	push   $0x33
  jmp alltraps
80105d16:	e9 65 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d1d:	6a 34                	push   $0x34
  jmp alltraps
80105d1f:	e9 5c f9 ff ff       	jmp    80105680 <alltraps>
...
80105d26:	6a 35                	push   $0x35
  jmp alltraps
80105d28:	e9 53 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d2f:	6a 36                	push   $0x36
  jmp alltraps
80105d31:	e9 4a f9 ff ff       	jmp    80105680 <alltraps>
...
80105d38:	6a 37                	push   $0x37
  jmp alltraps
80105d3a:	e9 41 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d41:	6a 38                	push   $0x38
  jmp alltraps
80105d43:	e9 38 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d4a:	6a 39                	push   $0x39
  jmp alltraps
80105d4c:	e9 2f f9 ff ff       	jmp    80105680 <alltraps>
...
80105d53:	6a 3a                	push   $0x3a
  jmp alltraps
80105d55:	e9 26 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d5c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d5e:	e9 1d f9 ff ff       	jmp    80105680 <alltraps>
...
80105d65:	6a 3c                	push   $0x3c
  jmp alltraps
80105d67:	e9 14 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d6e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d70:	e9 0b f9 ff ff       	jmp    80105680 <alltraps>
...
80105d77:	6a 3e                	push   $0x3e
  jmp alltraps
80105d79:	e9 02 f9 ff ff       	jmp    80105680 <alltraps>
...
80105d80:	6a 3f                	push   $0x3f
  jmp alltraps
80105d82:	e9 f9 f8 ff ff       	jmp    80105680 <alltraps>
...
80105d89:	6a 40                	push   $0x40
  jmp alltraps
80105d8b:	e9 f0 f8 ff ff       	jmp    80105680 <alltraps>
...
80105d92:	6a 41                	push   $0x41
  jmp alltraps
80105d94:	e9 e7 f8 ff ff       	jmp    80105680 <alltraps>
...
80105d9b:	6a 42                	push   $0x42
  jmp alltraps
80105d9d:	e9 de f8 ff ff       	jmp    80105680 <alltraps>
...
80105da4:	6a 43                	push   $0x43
  jmp alltraps
80105da6:	e9 d5 f8 ff ff       	jmp    80105680 <alltraps>
...
80105dad:	6a 44                	push   $0x44
  jmp alltraps
80105daf:	e9 cc f8 ff ff       	jmp    80105680 <alltraps>
...
80105db6:	6a 45                	push   $0x45
  jmp alltraps
80105db8:	e9 c3 f8 ff ff       	jmp    80105680 <alltraps>
...
80105dbf:	6a 46                	push   $0x46
  jmp alltraps
80105dc1:	e9 ba f8 ff ff       	jmp    80105680 <alltraps>
...
80105dc8:	6a 47                	push   $0x47
  jmp alltraps
80105dca:	e9 b1 f8 ff ff       	jmp    80105680 <alltraps>
...
80105dd1:	6a 48                	push   $0x48
  jmp alltraps
80105dd3:	e9 a8 f8 ff ff       	jmp    80105680 <alltraps>
...
80105dda:	6a 49                	push   $0x49
  jmp alltraps
80105ddc:	e9 9f f8 ff ff       	jmp    80105680 <alltraps>
...
80105de3:	6a 4a                	push   $0x4a
  jmp alltraps
80105de5:	e9 96 f8 ff ff       	jmp    80105680 <alltraps>
...
80105dec:	6a 4b                	push   $0x4b
  jmp alltraps
80105dee:	e9 8d f8 ff ff       	jmp    80105680 <alltraps>
...
80105df5:	6a 4c                	push   $0x4c
  jmp alltraps
80105df7:	e9 84 f8 ff ff       	jmp    80105680 <alltraps>
...
80105dfe:	6a 4d                	push   $0x4d
  jmp alltraps
80105e00:	e9 7b f8 ff ff       	jmp    80105680 <alltraps>
...
80105e07:	6a 4e                	push   $0x4e
  jmp alltraps
80105e09:	e9 72 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e10:	6a 4f                	push   $0x4f
  jmp alltraps
80105e12:	e9 69 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e19:	6a 50                	push   $0x50
  jmp alltraps
80105e1b:	e9 60 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e22:	6a 51                	push   $0x51
  jmp alltraps
80105e24:	e9 57 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e2b:	6a 52                	push   $0x52
  jmp alltraps
80105e2d:	e9 4e f8 ff ff       	jmp    80105680 <alltraps>
...
80105e34:	6a 53                	push   $0x53
  jmp alltraps
80105e36:	e9 45 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e3d:	6a 54                	push   $0x54
  jmp alltraps
80105e3f:	e9 3c f8 ff ff       	jmp    80105680 <alltraps>
...
80105e46:	6a 55                	push   $0x55
  jmp alltraps
80105e48:	e9 33 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e4f:	6a 56                	push   $0x56
  jmp alltraps
80105e51:	e9 2a f8 ff ff       	jmp    80105680 <alltraps>
...
80105e58:	6a 57                	push   $0x57
  jmp alltraps
80105e5a:	e9 21 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e61:	6a 58                	push   $0x58
  jmp alltraps
80105e63:	e9 18 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e6a:	6a 59                	push   $0x59
  jmp alltraps
80105e6c:	e9 0f f8 ff ff       	jmp    80105680 <alltraps>
...
80105e73:	6a 5a                	push   $0x5a
  jmp alltraps
80105e75:	e9 06 f8 ff ff       	jmp    80105680 <alltraps>
...
80105e7c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e7e:	e9 fd f7 ff ff       	jmp    80105680 <alltraps>
...
80105e85:	6a 5c                	push   $0x5c
  jmp alltraps
80105e87:	e9 f4 f7 ff ff       	jmp    80105680 <alltraps>
...
80105e8e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e90:	e9 eb f7 ff ff       	jmp    80105680 <alltraps>
...
80105e97:	6a 5e                	push   $0x5e
  jmp alltraps
80105e99:	e9 e2 f7 ff ff       	jmp    80105680 <alltraps>
...
80105ea0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ea2:	e9 d9 f7 ff ff       	jmp    80105680 <alltraps>
...
80105ea9:	6a 60                	push   $0x60
  jmp alltraps
80105eab:	e9 d0 f7 ff ff       	jmp    80105680 <alltraps>
...
80105eb2:	6a 61                	push   $0x61
  jmp alltraps
80105eb4:	e9 c7 f7 ff ff       	jmp    80105680 <alltraps>
...
80105ebb:	6a 62                	push   $0x62
  jmp alltraps
80105ebd:	e9 be f7 ff ff       	jmp    80105680 <alltraps>
...
80105ec4:	6a 63                	push   $0x63
  jmp alltraps
80105ec6:	e9 b5 f7 ff ff       	jmp    80105680 <alltraps>
...
80105ecd:	6a 64                	push   $0x64
  jmp alltraps
80105ecf:	e9 ac f7 ff ff       	jmp    80105680 <alltraps>
...
80105ed6:	6a 65                	push   $0x65
  jmp alltraps
80105ed8:	e9 a3 f7 ff ff       	jmp    80105680 <alltraps>
...
80105edf:	6a 66                	push   $0x66
  jmp alltraps
80105ee1:	e9 9a f7 ff ff       	jmp    80105680 <alltraps>
...
80105ee8:	6a 67                	push   $0x67
  jmp alltraps
80105eea:	e9 91 f7 ff ff       	jmp    80105680 <alltraps>
...
80105ef1:	6a 68                	push   $0x68
  jmp alltraps
80105ef3:	e9 88 f7 ff ff       	jmp    80105680 <alltraps>
...
80105efa:	6a 69                	push   $0x69
  jmp alltraps
80105efc:	e9 7f f7 ff ff       	jmp    80105680 <alltraps>
...
80105f03:	6a 6a                	push   $0x6a
  jmp alltraps
80105f05:	e9 76 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f0c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f0e:	e9 6d f7 ff ff       	jmp    80105680 <alltraps>
...
80105f15:	6a 6c                	push   $0x6c
  jmp alltraps
80105f17:	e9 64 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f1e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f20:	e9 5b f7 ff ff       	jmp    80105680 <alltraps>
...
80105f27:	6a 6e                	push   $0x6e
  jmp alltraps
80105f29:	e9 52 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f30:	6a 6f                	push   $0x6f
  jmp alltraps
80105f32:	e9 49 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f39:	6a 70                	push   $0x70
  jmp alltraps
80105f3b:	e9 40 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f42:	6a 71                	push   $0x71
  jmp alltraps
80105f44:	e9 37 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f4b:	6a 72                	push   $0x72
  jmp alltraps
80105f4d:	e9 2e f7 ff ff       	jmp    80105680 <alltraps>
...
80105f54:	6a 73                	push   $0x73
  jmp alltraps
80105f56:	e9 25 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f5d:	6a 74                	push   $0x74
  jmp alltraps
80105f5f:	e9 1c f7 ff ff       	jmp    80105680 <alltraps>
...
80105f66:	6a 75                	push   $0x75
  jmp alltraps
80105f68:	e9 13 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f6f:	6a 76                	push   $0x76
  jmp alltraps
80105f71:	e9 0a f7 ff ff       	jmp    80105680 <alltraps>
...
80105f78:	6a 77                	push   $0x77
  jmp alltraps
80105f7a:	e9 01 f7 ff ff       	jmp    80105680 <alltraps>
...
80105f81:	6a 78                	push   $0x78
  jmp alltraps
80105f83:	e9 f8 f6 ff ff       	jmp    80105680 <alltraps>
...
80105f8a:	6a 79                	push   $0x79
  jmp alltraps
80105f8c:	e9 ef f6 ff ff       	jmp    80105680 <alltraps>
...
80105f93:	6a 7a                	push   $0x7a
  jmp alltraps
80105f95:	e9 e6 f6 ff ff       	jmp    80105680 <alltraps>
...
80105f9c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f9e:	e9 dd f6 ff ff       	jmp    80105680 <alltraps>
...
80105fa5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fa7:	e9 d4 f6 ff ff       	jmp    80105680 <alltraps>
...
80105fae:	6a 7d                	push   $0x7d
  jmp alltraps
80105fb0:	e9 cb f6 ff ff       	jmp    80105680 <alltraps>
...
80105fb7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fb9:	e9 c2 f6 ff ff       	jmp    80105680 <alltraps>
...
80105fc0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fc2:	e9 b9 f6 ff ff       	jmp    80105680 <alltraps>
...
80105fc9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fce:	e9 ad f6 ff ff       	jmp    80105680 <alltraps>
...
80105fd5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fda:	e9 a1 f6 ff ff       	jmp    80105680 <alltraps>
...
80105fe1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fe6:	e9 95 f6 ff ff       	jmp    80105680 <alltraps>
...
80105fed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105ff2:	e9 89 f6 ff ff       	jmp    80105680 <alltraps>
...
80105ff9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105ffe:	e9 7d f6 ff ff       	jmp    80105680 <alltraps>
...
80106005:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010600a:	e9 71 f6 ff ff       	jmp    80105680 <alltraps>
...
80106011:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106016:	e9 65 f6 ff ff       	jmp    80105680 <alltraps>
...
8010601d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106022:	e9 59 f6 ff ff       	jmp    80105680 <alltraps>
...
80106029:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010602e:	e9 4d f6 ff ff       	jmp    80105680 <alltraps>
...
80106035:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010603a:	e9 41 f6 ff ff       	jmp    80105680 <alltraps>
...
80106041:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106046:	e9 35 f6 ff ff       	jmp    80105680 <alltraps>
...
8010604d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106052:	e9 29 f6 ff ff       	jmp    80105680 <alltraps>
...
80106059:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010605e:	e9 1d f6 ff ff       	jmp    80105680 <alltraps>
...
80106065:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010606a:	e9 11 f6 ff ff       	jmp    80105680 <alltraps>
...
80106071:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106076:	e9 05 f6 ff ff       	jmp    80105680 <alltraps>
...
8010607d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106082:	e9 f9 f5 ff ff       	jmp    80105680 <alltraps>
...
80106089:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010608e:	e9 ed f5 ff ff       	jmp    80105680 <alltraps>
...
80106095:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010609a:	e9 e1 f5 ff ff       	jmp    80105680 <alltraps>
...
801060a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060a6:	e9 d5 f5 ff ff       	jmp    80105680 <alltraps>
...
801060ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060b2:	e9 c9 f5 ff ff       	jmp    80105680 <alltraps>
...
801060b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060be:	e9 bd f5 ff ff       	jmp    80105680 <alltraps>
...
801060c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060ca:	e9 b1 f5 ff ff       	jmp    80105680 <alltraps>
...
801060d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060d6:	e9 a5 f5 ff ff       	jmp    80105680 <alltraps>
...
801060dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060e2:	e9 99 f5 ff ff       	jmp    80105680 <alltraps>
...
801060e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060ee:	e9 8d f5 ff ff       	jmp    80105680 <alltraps>
...
801060f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801060fa:	e9 81 f5 ff ff       	jmp    80105680 <alltraps>
...
80106101:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106106:	e9 75 f5 ff ff       	jmp    80105680 <alltraps>
...
8010610d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106112:	e9 69 f5 ff ff       	jmp    80105680 <alltraps>
...
80106119:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010611e:	e9 5d f5 ff ff       	jmp    80105680 <alltraps>
...
80106125:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010612a:	e9 51 f5 ff ff       	jmp    80105680 <alltraps>
...
80106131:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106136:	e9 45 f5 ff ff       	jmp    80105680 <alltraps>
...
8010613d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106142:	e9 39 f5 ff ff       	jmp    80105680 <alltraps>
...
80106149:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010614e:	e9 2d f5 ff ff       	jmp    80105680 <alltraps>
...
80106155:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010615a:	e9 21 f5 ff ff       	jmp    80105680 <alltraps>
...
80106161:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106166:	e9 15 f5 ff ff       	jmp    80105680 <alltraps>
...
8010616d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106172:	e9 09 f5 ff ff       	jmp    80105680 <alltraps>
...
80106179:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010617e:	e9 fd f4 ff ff       	jmp    80105680 <alltraps>
...
80106185:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010618a:	e9 f1 f4 ff ff       	jmp    80105680 <alltraps>
...
80106191:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106196:	e9 e5 f4 ff ff       	jmp    80105680 <alltraps>
...
8010619d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061a2:	e9 d9 f4 ff ff       	jmp    80105680 <alltraps>
...
801061a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061ae:	e9 cd f4 ff ff       	jmp    80105680 <alltraps>
...
801061b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061ba:	e9 c1 f4 ff ff       	jmp    80105680 <alltraps>
...
801061c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061c6:	e9 b5 f4 ff ff       	jmp    80105680 <alltraps>
...
801061cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061d2:	e9 a9 f4 ff ff       	jmp    80105680 <alltraps>
...
801061d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061de:	e9 9d f4 ff ff       	jmp    80105680 <alltraps>
...
801061e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061ea:	e9 91 f4 ff ff       	jmp    80105680 <alltraps>
...
801061f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801061f6:	e9 85 f4 ff ff       	jmp    80105680 <alltraps>
...
801061fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106202:	e9 79 f4 ff ff       	jmp    80105680 <alltraps>
...
80106209:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010620e:	e9 6d f4 ff ff       	jmp    80105680 <alltraps>
...
80106215:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010621a:	e9 61 f4 ff ff       	jmp    80105680 <alltraps>
...
80106221:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106226:	e9 55 f4 ff ff       	jmp    80105680 <alltraps>
...
8010622d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106232:	e9 49 f4 ff ff       	jmp    80105680 <alltraps>
...
80106239:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010623e:	e9 3d f4 ff ff       	jmp    80105680 <alltraps>
...
80106245:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010624a:	e9 31 f4 ff ff       	jmp    80105680 <alltraps>
...
80106251:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106256:	e9 25 f4 ff ff       	jmp    80105680 <alltraps>
...
8010625d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106262:	e9 19 f4 ff ff       	jmp    80105680 <alltraps>
...
80106269:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010626e:	e9 0d f4 ff ff       	jmp    80105680 <alltraps>
...
80106275:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010627a:	e9 01 f4 ff ff       	jmp    80105680 <alltraps>
...
80106281:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106286:	e9 f5 f3 ff ff       	jmp    80105680 <alltraps>
...
8010628d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106292:	e9 e9 f3 ff ff       	jmp    80105680 <alltraps>
...
80106299:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010629e:	e9 dd f3 ff ff       	jmp    80105680 <alltraps>
...
801062a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062aa:	e9 d1 f3 ff ff       	jmp    80105680 <alltraps>
...
801062b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062b6:	e9 c5 f3 ff ff       	jmp    80105680 <alltraps>
...
801062bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062c2:	e9 b9 f3 ff ff       	jmp    80105680 <alltraps>
...
801062c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062ce:	e9 ad f3 ff ff       	jmp    80105680 <alltraps>
...
801062d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062da:	e9 a1 f3 ff ff       	jmp    80105680 <alltraps>
...
801062e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062e6:	e9 95 f3 ff ff       	jmp    80105680 <alltraps>
...
801062ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801062f2:	e9 89 f3 ff ff       	jmp    80105680 <alltraps>
...
801062f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801062fe:	e9 7d f3 ff ff       	jmp    80105680 <alltraps>
...
80106305:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010630a:	e9 71 f3 ff ff       	jmp    80105680 <alltraps>
...
80106311:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106316:	e9 65 f3 ff ff       	jmp    80105680 <alltraps>
...
8010631d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106322:	e9 59 f3 ff ff       	jmp    80105680 <alltraps>
...
80106329:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010632e:	e9 4d f3 ff ff       	jmp    80105680 <alltraps>
...
80106335:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010633a:	e9 41 f3 ff ff       	jmp    80105680 <alltraps>
...
80106341:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106346:	e9 35 f3 ff ff       	jmp    80105680 <alltraps>
...
8010634d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106352:	e9 29 f3 ff ff       	jmp    80105680 <alltraps>
...
80106359:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010635e:	e9 1d f3 ff ff       	jmp    80105680 <alltraps>
...
80106365:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010636a:	e9 11 f3 ff ff       	jmp    80105680 <alltraps>
...
80106371:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106376:	e9 05 f3 ff ff       	jmp    80105680 <alltraps>
...
8010637d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106382:	e9 f9 f2 ff ff       	jmp    80105680 <alltraps>
...
80106389:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010638e:	e9 ed f2 ff ff       	jmp    80105680 <alltraps>
...
80106395:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010639a:	e9 e1 f2 ff ff       	jmp    80105680 <alltraps>
...
801063a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063a6:	e9 d5 f2 ff ff       	jmp    80105680 <alltraps>
...
801063ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063b2:	e9 c9 f2 ff ff       	jmp    80105680 <alltraps>
...
801063b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063be:	e9 bd f2 ff ff       	jmp    80105680 <alltraps>
...
801063c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063ca:	e9 b1 f2 ff ff       	jmp    80105680 <alltraps>
...
801063d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063d6:	e9 a5 f2 ff ff       	jmp    80105680 <alltraps>
...
801063dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063e2:	e9 99 f2 ff ff       	jmp    80105680 <alltraps>
...
801063e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063ee:	e9 8d f2 ff ff       	jmp    80105680 <alltraps>
...
801063f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801063fa:	e9 81 f2 ff ff       	jmp    80105680 <alltraps>
...
80106401:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106406:	e9 75 f2 ff ff       	jmp    80105680 <alltraps>
...
8010640d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106412:	e9 69 f2 ff ff       	jmp    80105680 <alltraps>
...
80106419:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010641e:	e9 5d f2 ff ff       	jmp    80105680 <alltraps>
...
80106425:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010642a:	e9 51 f2 ff ff       	jmp    80105680 <alltraps>
...
80106431:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106436:	e9 45 f2 ff ff       	jmp    80105680 <alltraps>
...
8010643d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106442:	e9 39 f2 ff ff       	jmp    80105680 <alltraps>
...
80106449:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010644e:	e9 2d f2 ff ff       	jmp    80105680 <alltraps>
...
80106455:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010645a:	e9 21 f2 ff ff       	jmp    80105680 <alltraps>
...
80106461:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106466:	e9 15 f2 ff ff       	jmp    80105680 <alltraps>
...
8010646d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106472:	e9 09 f2 ff ff       	jmp    80105680 <alltraps>
...
80106479:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010647e:	e9 fd f1 ff ff       	jmp    80105680 <alltraps>
...
80106485:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010648a:	e9 f1 f1 ff ff       	jmp    80105680 <alltraps>
...
80106491:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106496:	e9 e5 f1 ff ff       	jmp    80105680 <alltraps>
...
8010649d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064a2:	e9 d9 f1 ff ff       	jmp    80105680 <alltraps>
...
801064a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064ae:	e9 cd f1 ff ff       	jmp    80105680 <alltraps>
...
801064b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064ba:	e9 c1 f1 ff ff       	jmp    80105680 <alltraps>
...
801064c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064c6:	e9 b5 f1 ff ff       	jmp    80105680 <alltraps>
...
801064cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064d2:	e9 a9 f1 ff ff       	jmp    80105680 <alltraps>
...
801064d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064de:	e9 9d f1 ff ff       	jmp    80105680 <alltraps>
...
801064e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064ea:	e9 91 f1 ff ff       	jmp    80105680 <alltraps>
...
801064f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801064f6:	e9 85 f1 ff ff       	jmp    80105680 <alltraps>
...
801064fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106502:	e9 79 f1 ff ff       	jmp    80105680 <alltraps>
...
80106509:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010650e:	e9 6d f1 ff ff       	jmp    80105680 <alltraps>
...
80106515:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010651a:	e9 61 f1 ff ff       	jmp    80105680 <alltraps>
...
80106521:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106526:	e9 55 f1 ff ff       	jmp    80105680 <alltraps>
...
8010652d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106532:	e9 49 f1 ff ff       	jmp    80105680 <alltraps>
...
80106539:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010653e:	e9 3d f1 ff ff       	jmp    80105680 <alltraps>
...
80106545:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010654a:	e9 31 f1 ff ff       	jmp    80105680 <alltraps>
...
80106551:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106556:	e9 25 f1 ff ff       	jmp    80105680 <alltraps>
...
8010655d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106562:	e9 19 f1 ff ff       	jmp    80105680 <alltraps>
...
80106569:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010656e:	e9 0d f1 ff ff       	jmp    80105680 <alltraps>
...
80106575:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010657a:	e9 01 f1 ff ff       	jmp    80105680 <alltraps>
...
80106581:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106586:	e9 f5 f0 ff ff       	jmp    80105680 <alltraps>
...
8010658d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106592:	e9 e9 f0 ff ff       	jmp    80105680 <alltraps>
...
80106599:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010659e:	e9 dd f0 ff ff       	jmp    80105680 <alltraps>
...
801065a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065aa:	e9 d1 f0 ff ff       	jmp    80105680 <alltraps>
...
801065b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065b6:	e9 c5 f0 ff ff       	jmp    80105680 <alltraps>
...
801065bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065c2:	e9 b9 f0 ff ff       	jmp    80105680 <alltraps>
...
8010662a:	e8 e1 dd ff ff       	call   80104410 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066cd:	68 30 78 10 80       	push   $0x80107830
...
80106798:	66 89 90 58 28 11 80 	mov    %dx,-0x7feed7a8(%eax)
8010679f:	66 89 88 5a 28 11 80 	mov    %cx,-0x7feed7a6(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067a6:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801067ab:	31 c9                	xor    %ecx,%ecx
801067ad:	66 89 90 60 28 11 80 	mov    %dx,-0x7feed7a0(%eax)
...
801067b4:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067b9:	66 89 88 62 28 11 80 	mov    %cx,-0x7feed79e(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801067c0:	31 c9                	xor    %ecx,%ecx
801067c2:	66 89 90 68 28 11 80 	mov    %dx,-0x7feed798(%eax)
801067c9:	66 89 88 6a 28 11 80 	mov    %cx,-0x7feed796(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067d0:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801067d5:	31 c9                	xor    %ecx,%ecx
801067d7:	66 89 90 70 28 11 80 	mov    %dx,-0x7feed790(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801067de:	c6 80 5c 28 11 80 00 	movb   $0x0,-0x7feed7a4(%eax)
static inline void
...
801067ea:	c6 80 5d 28 11 80 9a 	movb   $0x9a,-0x7feed7a3(%eax)
801067f1:	c6 80 5e 28 11 80 cf 	movb   $0xcf,-0x7feed7a2(%eax)
801067f8:	c6 80 5f 28 11 80 00 	movb   $0x0,-0x7feed7a1(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067ff:	c6 80 64 28 11 80 00 	movb   $0x0,-0x7feed79c(%eax)
80106806:	c6 80 65 28 11 80 92 	movb   $0x92,-0x7feed79b(%eax)
8010680d:	c6 80 66 28 11 80 cf 	movb   $0xcf,-0x7feed79a(%eax)
80106814:	c6 80 67 28 11 80 00 	movb   $0x0,-0x7feed799(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010681b:	c6 80 6c 28 11 80 00 	movb   $0x0,-0x7feed794(%eax)
80106822:	c6 80 6d 28 11 80 fa 	movb   $0xfa,-0x7feed793(%eax)
80106829:	c6 80 6e 28 11 80 cf 	movb   $0xcf,-0x7feed792(%eax)
80106830:	c6 80 6f 28 11 80 00 	movb   $0x0,-0x7feed791(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106837:	66 89 88 72 28 11 80 	mov    %cx,-0x7feed78e(%eax)
8010683e:	c6 80 74 28 11 80 00 	movb   $0x0,-0x7feed78c(%eax)
80106845:	c6 80 75 28 11 80 f2 	movb   $0xf2,-0x7feed78b(%eax)
8010684c:	c6 80 76 28 11 80 cf 	movb   $0xcf,-0x7feed78a(%eax)
80106853:	c6 80 77 28 11 80 00 	movb   $0x0,-0x7feed789(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
8010685a:	05 50 28 11 80       	add    $0x80112850,%eax
...
80106880:	a1 04 55 11 80       	mov    0x80115504,%eax
...
801068c4:	0f 84 c4 00 00 00    	je     8010698e <switchuvm+0xee>
  ...
  pushcli();
801068ca:	e8 61 d9 ff ff       	call   80104230 <pushcli>
...
8010697b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010697c:	e9 ef d8 ff ff       	jmp    80104270 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106984:	68 36 78 10 80       	push   $0x80107836
...
80106991:	68 61 78 10 80       	push   $0x80107861
...
8010699e:	68 4c 78 10 80       	push   $0x8010784c
...
801069df:	e8 2c da ff ff       	call   80104410 <memset>
...
80106a10:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106a11:	e9 aa da ff ff       	jmp    801044c0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106a19:	68 75 78 10 80       	push   $0x80107875
...
80106acd:	68 8f 78 10 80       	push   $0x8010788f
...
80106ada:	68 30 79 10 80       	push   $0x80107930
...
80106b33:	e8 d8 d8 ff ff       	call   80104410 <memset>
...
80106b71:	68 ad 78 10 80       	push   $0x801078ad
...
80106ba3:	68 c5 78 10 80       	push   $0x801078c5
...
80106c8c:	68 e1 78 10 80       	push   $0x801078e1
...
80106cc0:	e8 4b d7 ff ff       	call   80104410 <memset>
...
80106d2b:	a3 04 55 11 80       	mov    %eax,0x80115504
...
80106d5f:	68 f2 78 10 80       	push   $0x801078f2
...
80106db0:	e8 0b d7 ff ff       	call   801044c0 <memmove>
...
80106e55:	68 16 79 10 80       	push   $0x80107916
...
80106e62:	68 fc 78 10 80       	push   $0x801078fc
...
80106eef:	e8 cc d5 ff ff       	call   801044c0 <memmove>
    len -= n;
    buf += n;
