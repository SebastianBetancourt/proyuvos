...
printf(2, "%d ticks have passed since startup", uptime());
  11:	e8 04 03 00 00       	call   31a <uptime>
...
printf(2, ", atleast 1 user\n");
  26:	58                   	pop    %eax
  27:	5a                   	pop    %edx
  28:	68 24 07 00 00       	push   $0x724
  2d:	6a 02                	push   $0x2
  2f:	e8 ac 03 00 00       	call   3e0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 40 07 00 00 	movzbl 0x740(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 36 07 00 00       	mov    $0x736,%eax
...
free(void *ap)
{
 ...
 581:	a1 d8 09 00 00       	mov    0x9d8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5d9:	a3 d8 09 00 00       	mov    %eax,0x9d8
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5fa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5fd:	a3 d8 09 00 00       	mov    %eax,0x9d8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 d8 09 00 00    	mov    0x9d8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	39 05 d8 09 00 00    	cmp    %eax,0x9d8
 ...
 696:	e8 e5 fe ff ff       	call   580 <free>
  return freep;
 69b:	8b 15 d8 09 00 00    	mov    0x9d8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6bf:	89 15 d8 09 00 00    	mov    %edx,0x9d8
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 d8 09 00 00 dc 	movl   $0x9dc,0x9d8
 6dd:	09 00 00 
 6e0:	c7 05 dc 09 00 00 dc 	movl   $0x9dc,0x9dc
 6e7:	09 00 00 
    base.s.size = 0;
 6ea:	b8 dc 09 00 00       	mov    $0x9dc,%eax
 6ef:	c7 05 e0 09 00 00 00 	movl   $0x0,0x9e0
 6f6:	00 00 00 
