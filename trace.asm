...
const char* syscalls[] = {
  11:	8d 5d 90             	lea    -0x70(%ebp),%ebx
  14:	be e0 07 00 00       	mov    $0x7e0,%esi
#include "user.h"
#include "fcntl.h"
...
main(int argc, char *argv[])
{
  19:	83 ec 68             	sub    $0x68,%esp
  1c:	8b 01                	mov    (%ecx),%eax
  1e:	8b 51 04             	mov    0x4(%ecx),%edx

const char* syscalls[] = {
  21:	89 df                	mov    %ebx,%edi
  23:	b9 16 00 00 00       	mov    $0x16,%ecx
  28:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
    "mkdir", "close", "trace"};
...
if (nsyscall == -1) {
  ...
  3b:	56                   	push   %esi
  3c:	e8 41 03 00 00       	call   382 <trace>
  41:	50                   	push   %eax
  42:	ff 34 b3             	pushl  (%ebx,%esi,4)
int nsyscall = -1;
if (argc == 2) {
  nsyscall = atoi(argv[1]);
}
if (nsyscall == -1) {
       for(int i = 0; i < SYSCALLC; i++)
  45:	83 c6 01             	add    $0x1,%esi
                printf(2, "%s %d\n", syscalls[i], trace(i));
  48:	68 60 07 00 00       	push   $0x760
  4d:	6a 02                	push   $0x2
...
if (nsyscall == -1) {
  ...
  57:	83 fe 16             	cmp    $0x16,%esi
  5a:	75 dc                	jne    38 <main+0x38>
                printf(2, "%s %d\n", syscalls[i], trace(i));
} else {
        printf(2, "%s %d\n", syscalls[nsyscall], trace(nsyscall));
}
 exit();
  5c:	e8 81 02 00 00       	call   2e2 <exit>
...
if (argc == 2) {
  ...
  67:	e8 04 02 00 00       	call   270 <atoi>
}
if (nsyscall == -1) {
  6c:	83 c4 10             	add    $0x10,%esp
  6f:	83 f8 ff             	cmp    $0xffffffff,%eax
...
if (nsyscall == -1) {
  ...
  79:	50                   	push   %eax
  7a:	e8 03 03 00 00       	call   382 <trace>
  7f:	50                   	push   %eax
  80:	ff 74 b5 90          	pushl  -0x70(%ebp,%esi,4)
  84:	68 60 07 00 00       	push   $0x760
  89:	6a 02                	push   $0x2
  8b:	e8 b0 03 00 00       	call   440 <printf>
  90:	83 c4 20             	add    $0x20,%esp
  93:	eb c7                	jmp    5c <main+0x5c>
  95:	66 90                	xchg   %ax,%ax
  97:	66 90                	xchg   %ax,%ax
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 38 08 00 00       	mov    $0x838,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 e4 0a 00 00       	mov    0xae4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 e4 0a 00 00       	mov    %eax,0xae4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 e4 0a 00 00    	cmp    %eax,0xae4
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 e4 0a 00 00    	mov    %edx,0xae4
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 73d:	0a 00 00 
 740:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 e8 0a 00 00       	mov    $0xae8,%eax
 74f:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 756:	00 00 00 
