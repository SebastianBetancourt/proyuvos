...
main(int argc, char *argv[])
{
  ...
  if (date(&r)) {
  14:	50                   	push   %eax
  15:	e8 30 03 00 00       	call   34a <date>
  ...
  21:	50                   	push   %eax
  22:	50                   	push   %eax
  23:	68 20 07 00 00       	push   $0x720
  28:	6a 02                	push   $0x2
  2a:	e8 d1 03 00 00       	call   400 <printf>
    exit();
  2f:	e8 6e 02 00 00       	call   2a2 <exit>
  }
  printf(2, "%d/%d/%d %d:%d:%d UTC\n",r.year, r.month, r.day, r.hour, r.minute, r.second);
  34:	ff 75 e0             	pushl  -0x20(%ebp)
  37:	ff 75 e4             	pushl  -0x1c(%ebp)
  3a:	ff 75 e8             	pushl  -0x18(%ebp)
  3d:	ff 75 ec             	pushl  -0x14(%ebp)
  40:	ff 75 f0             	pushl  -0x10(%ebp)
  43:	ff 75 f4             	pushl  -0xc(%ebp)
  46:	68 2d 07 00 00       	push   $0x72d
  4b:	6a 02                	push   $0x2
  4d:	e8 ae 03 00 00       	call   400 <printf>
  exit();
  52:	83 c4 20             	add    $0x20,%esp
  55:	e8 48 02 00 00       	call   2a2 <exit>
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	f7 f6                	div    %esi
 3a1:	0f b6 92 4c 07 00 00 	movzbl 0x74c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 44 07 00 00       	mov    $0x744,%eax
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 e4 09 00 00       	mov    %eax,0x9e4
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 e4 09 00 00       	mov    %eax,0x9e4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 e4 09 00 00    	mov    0x9e4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 e4 09 00 00    	mov    %edx,0x9e4
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 e4 09 00 00 e8 	movl   $0x9e8,0x9e4
 6fd:	09 00 00 
 700:	c7 05 e8 09 00 00 e8 	movl   $0x9e8,0x9e8
 707:	09 00 00 
    base.s.size = 0;
 70a:	b8 e8 09 00 00       	mov    $0x9e8,%eax
 70f:	c7 05 ec 09 00 00 00 	movl   $0x0,0x9ec
 716:	00 00 00 
